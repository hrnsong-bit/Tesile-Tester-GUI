...
class TempStabilizationDetector(QtCore.QObject):
    ...
    def __init__(self, check_interval: float = 1.0):
        """
        Args:
            check_interval: 온도 체크 주기 (초) - 기본값 1.0초
        """
        super().__init__()
        ...
        logger.info(f"TempStabilizationDetector 초기화 (check_interval={check_interval}s)")
